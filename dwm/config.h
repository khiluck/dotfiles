...
static const Rule rules[] = {
	...
	/* окно веб-камеры (webcamtoggle: mpv --x11-name=floatcam): плавающее + сразу
	 * sticky (последнее поле =1) — видно на всех столах, без квадратиков занятости */
	{ NULL,       "floatcam", NULL,       0,            1,           -1,      1 },
...
//	{ WINKEY,                       XK_p,      spawn,          {.v = cmdspotify } },
	{ MODKEY,                       XK_c,      spawn,          SHCMD("connect.sh") },
	{ MODKEY,                       XK_r,      spawn,          SHCMD("rdpconnect.sh") },
...
//	{ 0,							XK_Print, 					spawn,			{.v = scrshot } },
	...
	{ MODKEY|ShiftMask,             XK_0,      togglesticky,   {0} },  /* окно на все столы (sticky), без квадратиков занятости */
