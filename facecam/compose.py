...
#   глаз  — контур MediaPipe идёт по линии век, поэтому заливка захватывает
#           кольцо кожи века вокруг глаза. Поджимаем, чтобы остался сам глаз.
...
DILATE = {"left_eye": -2, "right_eye": -2, "lips": -2}
