...
# Взято +4 и +1: непрозрачность возвращена примерно к исходной, и при этом у
# губ не проступает тень усов, которая заметна уже на +2.
...
DILATE = {"left_eye": 4, "right_eye": 4, "lips": 1}
