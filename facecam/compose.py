...
# площадь:
#     глаз: +2 -> 72%,  +3 -> 93%,  +4 -> 119%,  +5 -> 144%
#     губы: +0 -> 76%,  +1 -> 88%,   +2 -> 104%
# Взято +3 и 0: непрозрачность глаза возвращена ровно к исходной (93%), а у
# губ 0 — это в точности кайма губ, без единого лишнего пикселя усов.
...
DILATE = {"left_eye": 3, "right_eye": 3, "lips": 0}
